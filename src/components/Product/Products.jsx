...
export default function Products() {
  ...
  // Get books from Redux store instead of static products
  ...
  const subCategories = [
    { name: "Fiction", href: "/products" },
    { name: "Non-Fiction", href: "/products" },
    { name: "Academic", href: "/products" },
    { name: "Children's Books", href: "/products" },
    { name: "Comics & Manga", href: "/products" },
  ];
  ...
  const filters = [
    {
      ...
      name: "Genre",
      options: [
        { value: "literary", label: "Literary Fiction", checked: false },
        { value: "mystery", label: "Mystery & Thriller", checked: false },
        { value: "scifi", label: "Science Fiction", checked: false },
    ...
    },
    {
      ...
      options: [
        ...
        { value: "ebook", label: "E-Book", checked: false },
        { value: "audiobook", label: "Audiobook", checked: false },
      ],
    },
    {
      id: "condition",
